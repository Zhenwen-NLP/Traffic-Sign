...
def __create_pyramid_features(C2, C3, C4, feature_size=256):

    # upsample C4 to get P4
    P4           = keras.layers.Conv2D(feature_size, kernel_size=1, strides=1, padding='same', name='C4_reduced')(C4)
    P4_upsampled = layers.UpsampleLike(name='P5_upsampled')([P4, C3])
    ...
    P6 = keras.layers.Activation('relu', name='C5_relu')(P5)
...
def retinanet(
    ...
    C2, C3, C4, _ = backbone.outputs  # we ignore C5
