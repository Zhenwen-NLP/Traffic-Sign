...
class CifarDataProvider(DataProvider):
    ...
    def __init__(self, save_path=None, validation_set=None,
        ...
        train_fnames, test_fnames = self.get_filenames()
    ...
    def read_cifar(self, filenames):
        ...
        for fname in filenames:
            ...
            imagePath = fname.split(' ')[0]
            print(imagePath)
            images = cv2.resize(cv2.imread(imagePath),(48,48))
        ...
        #print('shapeii', images_res.shape, labels_res.shape)
...
class My45DataProvider(CifarDataProvider):
    _n_classes = 46
    data_augmentation = False
    ...
    def get_filenames(self):
        ...
        count = int(len(filenames)*0.95)
        train_filenames = filenames[0:count]
        test_filenames = filenames[count:]
        return train_filenames, test_filenames
...
class My45AugmentedDataProvider(My45DataProvider):
    _n_classes = 46
    data_augmentation = True
